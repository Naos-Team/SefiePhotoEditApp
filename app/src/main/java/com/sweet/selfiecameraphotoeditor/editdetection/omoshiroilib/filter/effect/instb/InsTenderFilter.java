...
public class InsTenderFilter extends MultipleTextureFilter {
    public InsTenderFilter(Context context) {
        super(context, "filter/fsh/instb/tender.glsl");
        this.textureSize = 2;
    }
    ...
    public void init() {
        ...
        this.externalBitmapTextures[1].load(this.context, "filter/textures/inst/bluevintage_mask1.jpg");
    }
