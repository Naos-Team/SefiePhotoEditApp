...
public class InsSunsetFilter extends MultipleTextureFilter {
    ...
    public void init() {
        ...
        this.externalBitmapTextures[1].load(this.context, "filter/textures/inst/rise_mask1.jpg");
        this.externalBitmapTextures[2].load(this.context, "filter/textures/inst/rise_mask2.jpg");
    }
    ...
    private int prepareRawTexture1() {
        ...
        return TextureUtils.getTextureFromByteArray(bArr, 256, 2);
    }
}
