...
public class Emerald extends GPUImageFilter {
    ...
    class C11331 implements Runnable {
        ...
        public void run() {
            GLES20.glGenTextures(1, Emerald.this.mToneCurveTexture, 0);
            GLES20.glBindTexture(3553, Emerald.this.mToneCurveTexture[0]);
