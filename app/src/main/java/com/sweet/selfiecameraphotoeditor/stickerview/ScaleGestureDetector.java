...
public class ScaleGestureDetector {
     static final float PRESSURE_THRESHOLD = 0.67f;
     static final String TAG = "ScaleGestureDetector";
     boolean mActive0MostRecent;
     int mActiveId0;
     int mActiveId1;
     ...
     boolean mInvalidGesture;
     final OnScaleGestureListener mListener;
    ...
    public boolean onTouchEvent(View view, MotionEvent motionEvent) {
     ...
     int findNewActiveIndex(MotionEvent motionEvent, int i, int i2) {
        int pointerCount = motionEvent.getPointerCount();
     ...
     void setContext(View view, MotionEvent motionEvent) {
