...
import com.sweet.selfiecameraphotoeditor.activities.PhotoCreationFragment;
import com.sweet.selfiecameraphotoeditor.common.CustomTextView;

import java.io.File;

public class PhotoCreationAdapter extends BaseAdapter {
    ...
    public PhotoCreationAdapter(Activity activity2, String[] strArr, String[] strArr2) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.deleteBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                final Dialog dialog = new Dialog(PhotoCreationAdapter.this.activity);
                ...
                ((CustomTextView) dialog.findViewById(R.id.txt_yes)).setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        new File(PhotoCreationAdapter.this.filePath[intValue]).delete();
                        PhotoCreationAdapter.this.notifyDataSetChanged();
                        PhotoCreationFragment.refreshload();
                        dialog.dismiss();
                    }
                });
                dialog.show();
