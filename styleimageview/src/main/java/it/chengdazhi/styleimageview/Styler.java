...
public class Styler {
     ...
     * Simply setting params like mode and brightness1 won't bringing effect until this method is called.
     */
     ...
     * But this does not clear the brightness1 and contrast, if these two params are set.
    ...
    public Styler setBrightness(int brightness) {
        if (brightness > 255) {
            throw new IllegalArgumentException("brightness1 can't be bigger than 255");
        } else if (brightness < -255) {
            throw new IllegalArgumentException("brightness1 can't be smaller than -255");
        }
     ...
     * If you want to use saturation mode or specify brightness1 or contrast,
     * call addStyleToBitmap(Context context, Bitmap bitmap, int mode, int brightness1, float contrast, float saturation)
     * @param context
     ...
     * @param bitmap Bitmap object to change, we don't operate on this bitmap because it's immutable, you should use the returned bitmap object
     * @param mode
     * @param brightness if you don't want to change brightness1, pass 0
